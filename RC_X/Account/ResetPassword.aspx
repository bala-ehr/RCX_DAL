<%@ Page Language="C#" AutoEventWireup="true"  CodeBehind="ResetPassword.aspx.cs" Inherits="RC_X.ResetPassword" %> <%--MasterPageFile="~/Light.master"--%>
...
<dx:ASPxButton runat="server" ID="Reset" Text="Reset" OnClick="Reset_Click" /></form>
<%--</asp:content>--%>