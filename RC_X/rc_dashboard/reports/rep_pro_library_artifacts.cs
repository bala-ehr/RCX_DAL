...
/// <summary>
/// Summary description for rep_pro_library_artifacts
/// </summary>
public class rep_pro_library_artifacts : DevExpress.XtraReports.UI.XtraReport
{
    ...
    private DevExpress.XtraReports.Parameters.Parameter Home;
    ...
    public rep_pro_library_artifacts()
    {
        InitializeComponent();
        //
    ...
    private void InitializeComponent()
    {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(rep_pro_library_artifacts));
            ...
            this.Home = new DevExpress.XtraReports.Parameters.Parameter();
            ...
            table1.MetaSerializable = "<Meta X=\"30\" Y=\"30\" Width=\"125\" Height=\"369\" />";
            ...
            selectQuery1.FilterString = "[rc_repository.lib_deleted] = \'0\' And [rc_repository.lib_home] <> \'E\'";
            selectQuery1.GroupFilterString = "";
            selectQuery1.MetaSerializable = "<Meta X=\"-120\" Y=\"0\" Width=\"100\" Height=\"258\" />";
            selectQuery1.Name = "rc_repository";
            selectQuery1.Tables.Add(table1);
            columnExpression14.ColumnName = "RC_ID";
            table2.MetaSerializable = "<Meta X=\"30\" Y=\"30\" Width=\"125\" Height=\"134\" />";
            table2.Name = "view_all_assessment";
            columnExpression14.Table = table2;
            column14.Expression = columnExpression14;
            columnExpression15.ColumnName = "RC_NAME";
            columnExpression15.Table = table2;
            column15.Expression = columnExpression15;
            columnExpression16.ColumnName = "RC_TYPE";
            columnExpression16.Table = table2;
            column16.Expression = columnExpression16;
            columnExpression17.ColumnName = "att_pageref";
            table3.MetaSerializable = "<Meta X=\"185\" Y=\"30\" Width=\"125\" Height=\"172\" />";
            table3.Name = "rc_repository_attachments";
            columnExpression17.Table = table3;
            column17.Expression = columnExpression17;
            columnExpression18.ColumnName = "att_artifact";
            ...
            selectQuery2.MetaSerializable = "<Meta X=\"140\" Y=\"20\" Width=\"100\" Height=\"122\" />";
            selectQuery2.Name = "view_all_assessment";
            ...
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTable1.LocationFloat = new DevExpress.Utils.PointFloat(0F, 41.04166F);
            ...
            this.GroupHeader1.HeightF = 91.04166F;
            this.GroupHeader1.Name = "GroupHeader1";
            // 
            // LabelStyle
            // 
            this.LabelStyle.BackColor = System.Drawing.Color.LemonChiffon;
            ...
            // Home
            // 
            this.Home.Description = "Home";
            dynamicListLookUpSettings1.DataAdapter = null;
            dynamicListLookUpSettings1.DataMember = "rc_repository";
            dynamicListLookUpSettings1.DataSource = this.sqlDataSource1;
            dynamicListLookUpSettings1.DisplayMember = "lib_home";
            dynamicListLookUpSettings1.ValueMember = "lib_home";
            this.Home.LookUpSettings = dynamicListLookUpSettings1;
            this.Home.MultiValue = true;
            this.Home.Name = "Home";
            // 
            // rep_pro_library_artifacts
            // 
            ...
            this.FilterString = "[lib_home] In (?Home) And ([lib_projectID] = ?ProjectID Or [lib_projectID] Is Nul" +
    "l)";
    ...
    private void xrLabel4_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
    {
        ...
        switch (ArtifactHome.Text)
        {
            ...
            case "P":
                ...
                ArtifactHome.Text = this.Parameters["ProjectName"].Value.ToString() + " Project";
                ArtifactHome.BackColor = System.Drawing.ColorTranslator.FromHtml(ProjectColor);
                break;
            case "G":
